...
add_action( 'wp_ajax_nopriv_filterCategory', 'swipex_filter_category' );
add_action( 'wp_ajax_filterCategory', 'swipex_filter_category' );

function swipex_filter_category(){ 
